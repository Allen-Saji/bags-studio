...
const transforms = [
  { from: "Hype", to: "Community", img: "/hype-community.png", desc: "Launch buzz fades. A real community sticks around, engages, and grows with you." },
  { from: "Holders", to: "Supporters", img: "/holders-sopprters.png", desc: "Wallets on a list mean nothing. Supporters claim fees, complete quests, and refer friends." },
  { from: "Activity", to: "Momentum", img: "/activity-momentum.png", desc: "Random trades aren\u2019t progress. Momentum is sustained engagement you can measure and reward." },
];
          ...
          <div className="relative z-10 mx-auto flex max-w-7xl flex-col items-center px-6 pt-20 lg:flex-row lg:items-center lg:gap-12 lg:pt-28">
            <div className="flex-1 text-center lg:text-left">
              ...
              <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.4 }}
                ...
                <a href="#features" className="rounded-full border border-border-strong px-8 py-4 text-center text-base font-medium text-gray-300 transition-all hover:border-green/30 hover:text-white">Explore Features</a>
              </motion.div>
            ...
            <div className="grid gap-12 lg:grid-cols-5 lg:gap-16">
              <div className="lg:col-span-2">
                ...
                <motion.h2 {...fadeUp} transition={{ duration: 0.5, delay: 0.05 }} className="text-4xl font-extrabold leading-[1.1] tracking-[-0.02em] md:text-5xl" style={display}>
                  Most coins<br />launch.<br /><span className="text-gray-400">Few stay alive.</span>
                </motion.h2>
                <motion.p {...fadeUp} transition={{ duration: 0.5, delay: 0.1 }} className="mt-6 text-base leading-relaxed text-gray-300">
              ...
              <div className="flex flex-col gap-3 lg:col-span-3">
                {painPoints.map((point, i) => (
                  <motion.div key={i} initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true, margin: "-60px" }} transition={{ duration: 0.4, delay: i * 0.08 }}
                    ...
                    <div className="flex items-center gap-5">
                      ...
                      <span className="text-sm text-gray-300 transition-colors group-hover:text-white">{point}</span>
                ...
                <motion.div {...fadeUp} transition={{ duration: 0.5, delay: 0.35 }} className="mt-4 rounded-xl border border-green/20 bg-green-muted p-6 text-center">
                  <p className="text-base text-gray-300">Most tools stop at launch. <span className="font-bold text-green">BagsStudio starts there.</span></p>
                </motion.div>
              </div>
            </div>
          </div>
                      ...
                      <div className="space-y-2.5">
                        {f.rows.map(r => (
                          <div key={r.rank} className="flex items-center gap-3">
                            <span className="w-5 text-right text-[10px] text-gray-400" style={mono}>#{r.rank}</span>
        ...
        <section className="relative overflow-hidden px-6 py-28">
          ...
          <div className="relative z-10 mx-auto max-w-5xl">
            <div className="text-center">
              ...
              <motion.p {...fadeUp} transition={{ duration: 0.5, delay: 0.1 }} className="mx-auto mb-20 max-w-xl text-lg text-gray-300">
              ...
              {transforms.map((t, i) => (
                <motion.div key={t.from} initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: "-60px" }} transition={{ duration: 0.5, delay: i * 0.15 }}
                  ...
                  <div className="px-6 py-6">
                    ...
                    <p className="mt-3 text-sm leading-relaxed text-gray-300">{t.desc}</p>
                  </div>
                </motion.div>
              ))}
            </div>
        ...
        <section className="relative overflow-hidden px-6 py-28">
          ...
          <div className="relative z-10 mx-auto max-w-4xl text-center">
            ...
            <motion.div {...fadeUp} transition={{ duration: 0.5, delay: 0.1 }}>
              ...
              <p className="mx-auto mb-12 max-w-xl text-lg text-gray-300">BagsStudio gives Bags creators the tools to grow community, reward conviction, and keep momentum alive.</p>
              ...
              <div className="mt-16 flex items-center justify-center gap-3">
                <div className="h-px w-12 bg-border-subtle" /><span className="text-[10px] tracking-[0.3em] text-gray-400 uppercase" style={mono}>Powered by Bags</span><div className="h-px w-12 bg-border-subtle" />
              </div>
            </motion.div>
          </div>
        </section>
