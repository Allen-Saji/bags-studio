  ...
  if (connected && publicKey) {
    ...
    return (
      <div className="flex items-center gap-2 sm:gap-3">
        <div className="flex items-center gap-1.5 sm:gap-2 px-2 sm:px-3 py-1.5 rounded-lg bg-green-muted border border-green/20">
          <div className="w-2 h-2 rounded-full bg-green animate-pulse-dot" />
          <span className="text-xs sm:text-sm font-mono text-green">
